...
import RandomIdeasClient, { type IdeaItem } from "@/components/molecules/landing/random-ideas-client";
...
export default async function RandomIdeasSection() {
  ...
  const selected = sampleN(normalized, 10);

  return (
    <section aria-labelledby="ideas-table" className="relative mx-auto w-full max-w-6xl">
      <h2 id="ideas-table" className="relative text-lg font-semibold tracking-tight text-orange-500">
      ...
      <p className="mt-2 max-w-3xl text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
        10 server-picked ideas; questions become rows with a vibe check.
      </p>
