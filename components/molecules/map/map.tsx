...
export const Map = () => {
  return (
    ...
    >
      ...
      <div className='pt-12 text-base font-semibold tracking-tight text-emerald-400 sm:pt-20 sm:text-lg'>
        Farm Management
      </div>
      <h2
        id='management-title'
      ...
      <div className='relative mt-20 mb-10 ml-68 scale-90 sm:mb-16 md:mt-24 md:ml-0 md:scale-100'>
        ...
        <div className='absolute -top-3 left-[130px]'>
          <div className='relative flex items-center justify-center'>
            ...
            <div
              ...
              className='absolute size-10 animate-[ping_5s_ease_infinite] rounded-full ring-1 ring-emerald-500/50'
            ></div>
          </div>
        </div>
        ...
        <div className='absolute top-9 right-56'>
          <div className='relative flex items-center justify-center'>
            ...
            <div className='absolute size-10 rounded-full bg-gray-950 ring-1 ring-white/15 backdrop-blur-xs'></div>
          </div>
        </div>
      </div>
    </section>
