export function HypanyLogo({ className }: { className?: string }) {
	return (
		<svg
			className={className}
			viewBox="0 0 42 42"
...
export function HypanyMark({ className }: { className?: string }) {
	return <HypanyLogo className={className} />;
}
