...
import { CreateLandingPageButton } from '@/app/app/hypotheses/[id]/landing-pages/ui'

export default async function HypothesisLandingPagesBreadcrumbs({
  params,
}: {
  ...
  const resolved = await resolveEntityNameById(
    id,
